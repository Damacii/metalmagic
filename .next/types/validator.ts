...
// Validate ../../app/api/gallery/local/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/gallery/local">> = Specific
  const handler = {} as typeof import("../../app/api/gallery/local/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
